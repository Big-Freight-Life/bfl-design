# Applied AI Architect Page — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create a new `/applied-ai-architect` service page using the StoryBrand framework, and update the homepage POV badge to link to it.

**Architecture:** Single new page file at `src/app/applied-ai-architect/page.tsx` using existing `DarkHeroSection` component and MUI primitives. One small edit to `POVSection.tsx` to update the badge link. No new components needed.

**Tech Stack:** Next.js 16 App Router, MUI 7, TypeScript, existing design tokens from `src/theme/tokens.ts`

---

### Task 1: Create the Applied AI Architect page

**Files:**
- Create: `src/app/applied-ai-architect/page.tsx`

- [ ] **Step 1: Create the page file with metadata and all 6 sections**

Create `src/app/applied-ai-architect/page.tsx` with this content:
...
Run: `npm run build`
Expected: Compiles successfully with `/applied-ai-architect` in the route list.

- [ ] **Step 3: Commit**

```bash
git add src/app/applied-ai-architect/page.tsx
git commit -m "Add Applied AI Architect service page with StoryBrand narrative"
```

---

### Task 2: Update POV section badge link

**Files:**
- Modify: `src/components/sections/POVSection.tsx:85`

- [ ] **Step 1: Change the badge href**

In `src/components/sections/POVSection.tsx`, change line 85 from:
```tsx
            href="/transformation"
```
to:
...
```bash
git add src/components/sections/POVSection.tsx
git commit -m "Point homepage Applied AI Architect badge to new service page"
```
...
- [ ] **Step 1: Run the dev server and visually check the page**

Run: `npm run dev`
Visit `/applied-ai-architect` and verify:
- All 6 sections render correctly
- StoryBrand narrative flows top to bottom
- Cards in Section 3 display in 3-column grid on desktop, stack on mobile
- Facets in Section 4 display with dividers between them
- CTA section has both "Book a Call" button and "Or start with a message" link
- Dark/light mode both work

- [ ] **Step 2: Verify the homepage badge links to the new page**

Visit `/` and click the "Applied AI Architect" badge in the POV section.
Expected: Navigates to `/applied-ai-architect`.
